 ...
 */
public class ModeratorAuthInterceptor implements Interceptor {
    @Override
    public void destroy() {
    }
    ...
    public String intercept(ActionInvocation actionInvocation) throws Exception {
        ...
        User moderator = (User) session.get(ConstantGeneral.SESSION_USER);
        if (moderator == null || moderator.getProfile() != Profile.MODERATOR) {
