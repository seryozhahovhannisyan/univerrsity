        ...
        <div class="universities_content">
            <table style="width: 100%" class="faculty_degrees_content">
                ...
                <table class="edit_faculty_form"> <%--todo--%>
                    ...
                    <s:iterator var="degree" value="facultyDegrees">
                        <!-- Faculty-->
                        <tr>
                            <td>
                                <table>
                                    <tr>
                                        <td>
                                            <img width="96" height="96" src="<s:property value="#degree.faculty.logoPath"/>">
                                        </td>
                                        <td>
                                            <s:property value="#degree.faculty.name"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <s:property value="#degree.faculty.email"/>
                                        </td>
                                        <td>
                                            <s:property value="#degree.faculty.phone"/>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <s:property value="#degree.document.documentType"/>"
                                        </td>
                                        <s:url action="download" id="download">
                                            <s:param name="filePath"><s:property value="#degree.document.path"/></s:param>
                                        </s:url>
                                        <td>
                                            <a href="${download}">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                           <p><s:property value="#degree.document.about"/></p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
